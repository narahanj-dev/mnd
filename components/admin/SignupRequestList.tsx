...
type RequestItem = { id: string; name: string; department: string; contact: string; birth_date: string; requested_login_id: string; reason: string | null; status: "pending" | "approved" | "rejected"; rejection_reason: string | null; created_at: string };
